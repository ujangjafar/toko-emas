...
<div class="py-6">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 bg-gold-light rounded-md p-3">
        ...
        <div class="mt-8">
            <div class="bg-white shadow overflow-hidden sm:rounded-md">
                <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                    ...
                    <a href="{{ route('admin.orders.index') }}" class="text-gold hover:text-gold-dark text-sm">Lihat Semua</a>
                </div>
        ...
        <div class="mt-8">
            <div class="bg-white shadow overflow-hidden sm:rounded-md">
                <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Produk Stok Menipis</h3>
                    <a href="{{ route('admin.products.index') }}" class="text-gold hover:text-gold-dark text-sm">Lihat Semua</a>
                </div>
                <div class="border-t border-gray-200">
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
